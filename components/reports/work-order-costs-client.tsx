...
export function WorkOrderCostsClient({
  workOrderId,
  costTypes,
  costCodes,
  onFiltersChange,
  ...
  const handleFiltersChange = useCallback(
    (newFilters: JobCostFilters) => {
      ...
      router.push(`/app/work-orders/${workOrderId}/costs?${params.toString()}`)
      onFiltersChange(newFilters)
    },
    [router, workOrderId, onFiltersChange]
  )
  ...
  const handleClearFilter = useCallback(
    (filterKey: string) => {
      ...
      const newUrl = params.toString() ? `/app/work-orders/${workOrderId}/costs?${params.toString()}` : `/app/work-orders/${workOrderId}/costs`
      router.push(newUrl)
    },
